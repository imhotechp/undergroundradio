...
} from "@/components/UndergroundRadioSpray";
import { SprayOptionsMenu } from "@/components/SprayOptionsMenu";
import { clampSpeed, loadSprayPreferences, saveSprayPreferences } from "@/lib/spray-preferences";
...
export const Route = createFileRoute("/")({
  head: () => ({
    meta: [
      { title: "undergroundradio — 3D Spray Paint Logo" },
      {
        name: "description",
        content:
          "Professional 3D spray paint SVG animation for undergroundradio with Framer Motion and responsive design.",
      },
