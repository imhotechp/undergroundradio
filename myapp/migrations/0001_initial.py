# Generated by Django 5.2.9 on 2026-07-24 01:42
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('producer', models.CharField(blank=True, null=True)),
                ('lyrics', models.CharField(blank=True, null=True)),
                ('duration', models.DurationField(blank=True, null=True)),
                ('coverArt', models.CharField()),
                ('plays', models.IntegerField(blank=True, null=True)),
                ('nft_status', models.BooleanField(blank=True, null=True)),
            ],
        ),
        migrations.CreateModel(
            name='User',
